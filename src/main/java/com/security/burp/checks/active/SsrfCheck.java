...
public final class SsrfCheck extends AbstractActiveCheck {
    ...
    /**
     * Cross-reference to Burp's native scanner. Burp's out-of-band SSRF and
     * path-traversal detection (via Collaborator) is more reliable than
     * reflection-based probing; this line points the analyst to it.
     */
